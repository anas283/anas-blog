        ...
        <div className="flex flex-col mt-4 ml-1.5">
          <div className="border-l border-slate-300 pl-4 pb-4 relative">
            ...
            <div className="flex flex-row gap-3">
              ...
              <Badge className="font-normal">Present</Badge>
            </div>
      ...
      <div className="mt-16">
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-x-6">
          <a 
            ...
            target="_blank"
          >
            <div className="w-8 h-8 rounded-md bg-slate-900 flex justify-center items-center text-white ease-in-out duration-200 group-hover:-rotate-12">
              L
            </div>
