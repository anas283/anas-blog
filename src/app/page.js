...
import YellowLine from "../../public/yellow-line.png";
import PurpleLine from "../../public/purple-line.png";

export default function Home() {
  return (
    <main className="relative overflow-x-hidden">
      <div className="flex max-w-screen-md mx-auto min-h-screen items-center justify-between px-6 py-24 md:px-0 overflow-x-hidden">
        <Image className="w-32 md:w-64 h-auto absolute z-1 top-48 -left-14" src={YellowLine} alt="line" />
        <Image className="w-32 md:w-64 h-auto absolute z-1 top-48 -right-14" src={PurpleLine} alt="line" />
